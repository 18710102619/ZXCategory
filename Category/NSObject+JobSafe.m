...
- (void)job_sd_setImageWithURL:(nullable NSURL *)url placeholderImage:(nullable UIImage *)placeholder
{
    if ([self isKindOfClass:[UIImageView class]]) {
        ...
        if ([url isKindOfClass:[NSURL class]]) {
              [imageView sd_setImageWithURL:[NSURL URLWithString:[self job_getUrlString:url.absoluteString] ] placeholderImage:placeholder];
        }
        if ([url isKindOfClass:[NSString class]]) {
             [imageView sd_setImageWithURL:[NSURL URLWithString:[self job_getUrlString:(NSString *)url]] placeholderImage:placeholder];
        }
    }
}
